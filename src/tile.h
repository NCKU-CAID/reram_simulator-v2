...
public:
    ...
    void originalWeight(int NumCellPerWeight, int maxNumWeightPerRow, int weightPrecision, int sign = 1);
    float getPower(int input, float VDD = 0.9);
...
private:
    ...
    // SRAM power table for 6-bit and 7-bit output
